...
public class InitDatabaseBean {
    ...
    public void init() throws ParseException {
        ...
        m.setEventDate(sdf.parse("25/08/2012 20:45:00"));
        ...
        m1.setEventDate(sdf.parse("25/08/2012 20:45:00"));
        ...
        m2.setEventDate(sdf.parse("26/08/2012 18:00:00"));
        ...
        m3.setEventDate(sdf.parse("26/08/2012 18:00:00"));
        ...
        m4.setEventDate(sdf.parse("26/08/2012 12:00:00"));
        ...
        m5.setEventDate(sdf.parse("26/08/2012 20:45:00"));
